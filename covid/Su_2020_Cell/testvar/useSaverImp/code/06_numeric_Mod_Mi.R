...
system.time({
  res <- testpt.seed(expr=expr, cellanno=cellanno, pseudotime=pt, design=design, type='Variable', ncores = 16, demean = FALSE)
})
saveRDS(res, paste0(rdir, 'numeric_Mod_Mi_res.rds'))
