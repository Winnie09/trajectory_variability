...
##  1
res <- testpt(expr = m, cellanno = ca, pseudotime = pt, design=design, permuiter=10, EMmaxiter=100, EMitercutoff=1, verbose=F, ncores=1,type='Variable', test.type = 'slope', test.position = 'all')
