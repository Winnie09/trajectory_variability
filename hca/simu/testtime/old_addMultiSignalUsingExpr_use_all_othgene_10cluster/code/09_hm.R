...
for (dataType in seq(1,4)){
  ddir <- here('hca','data','simu','testtime','addMultiSignalUsingExpr_use_all_othgene_10cluster')
  ...
  col.gs <-   colorRampPalette(rev(brewer.pal(n = 8, name = "Dark2")))(length(unique(rowann$gs)))
