...
saveRDS(res, '/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/covid/result/trenddiff.rds')


## meandiff
meanres <- meandiff(expr = m, cellanno = cellanno, design = design)
saveRDS(meanres, '/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/covid/result/meandiff.rds')
