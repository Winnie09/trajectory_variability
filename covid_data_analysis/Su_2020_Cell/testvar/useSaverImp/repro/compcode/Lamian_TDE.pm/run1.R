...
rdir <- paste0('covid/Su_2020_Cell/testvar/useSaverImp/repro/compres/Lamian_TDE.pm/')
...
res1 <- testpt(expr=expr, cellanno=cellanno1, pseudotime=pt[cellanno1[,1]], design=design[samp1,1,drop=FALSE], test.type='Time', ncores = 15, demean = FALSE, test.method = 'permutation')
