...
res2 <- testpt(expr=expr, cellanno=cellanno2, pseudotime=pt[cellanno2[,1]], design=design[samp2,1,drop=FALSE], test.type='Time', ncores = 15, demean = FALSE, test.method = 'permutation')
