...
cell <- readRDS('/home-4/zji4@jhu.edu/scratch/diffpt/covid/GSE155673_pbmc/CD8cell.rds')
d <- d[,cell]
...
saveRDS(integrated,file='/home-4/zji4@jhu.edu/scratch/diffpt/covid/GSE155673_pbmc/CD8integrate.rds')
