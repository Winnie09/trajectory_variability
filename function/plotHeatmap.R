plotHeatmap <- function(testptObj, Mat, Pseudotime, Cellanno, Design, Max.gene = NULL, heatmap.x = 0.4, heatmap.y = 0.5, heatmap.width = 0.8, heatmap.height = 1.0, dend.x = 0.90, dend.y = 0.44, dend.width = 0.2, dend.height = 0.98){
  library(ggplot2)
  library(ggdendro)
  library(reshape2)
  library(grid)
