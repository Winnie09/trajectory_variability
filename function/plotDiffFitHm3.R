plotDiffFitHm3 <- function(testobj, showRowName = FALSE, cellWidthTotal = 250, cellHeightTotal = 400, showCluster = FALSE, colann = NULL, rowann = NULL, annotation_colors = NULL, type = 'time', subsampleCell = TRUE, numSubsampleCell=1e3, sep = NA){
  ...
  plist[[4]] <- ggplot(data=NULL) + geom_blank() + theme_void()
