plotmclust <- function (mclustobj, x = 1, y = 2, MSTorder = NULL, show_tree = T, 
    show_full_tree = T, show_cell_names = F, cell_name_size = 3, 
    cell_point_size = 3, markerexpr = NULL, showcluster = T, x.lab = 'PC1', y.lab = 'PC2',
    subset.cell = NULL) 
{   
    ## subset.cell: a character vector of the names of the selected cells to plot, when NULL, plot all cells.
    color_by = "State"
