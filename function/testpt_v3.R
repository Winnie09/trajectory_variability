testpt_v3 <- function(expr, cellanno, pseudotime, design=NULL, permuiter=100, EMmaxiter=100, EMitercutoff=1, verbose=F, ncores=detectCores(),type='Time', test.type = 'slope', test.position = 'all', fit.resolution = 1000) {
  ...
  pred <- predict(knotnum = knotnum, design = design, cellanno = cellanno, pseudotime = pseudotime)
