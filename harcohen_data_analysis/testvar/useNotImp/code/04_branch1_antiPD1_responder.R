...
system.time({
  res <- testpt(expr=m, cellanno=cellanno, pseudotime=pseudotime, design=design, type='Variable', ncores = 4, demean = FALSE)
})
saveRDS(res, paste0(rdir, 'branch1_antiPD1_responder_res.rds'))
