...
fitpt <- function(expr, pseudotime, design, targetgene=NULL,boot=NULL, maxknotallowed=10, EMmaxiter=100, EMitercutoff=0.05, verbose=F, ncores=1, model = 3, knotnum = NULL) {
