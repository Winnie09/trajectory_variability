...
## Lamian.pm
lamian <- readRDS(paste0('/home/whou10/scratch16/whou10/trajectory_variability/tb/res/sex/pc2/lamian_pm_allcores.rds'))[[1]]
...
## limma
limma <- readRDS(paste0('/home/whou10/scratch16/whou10/trajectory_variability/tb/res/sex_noBatch/pc2/limma.rds'))
...
## Lamian.chisq
lamc <- readRDS(paste0('/home/whou10/scratch16/whou10/trajectory_variability/tb/res/sex/pc2/lamian_chisq.rds'))[[1]]
lamcgenes <- rownames(lamc)[order(lamc[,2])] ## all genes order
lamcsig <- rownames(lamc)[lamc[,'fdr.chisq.overall'] < 0.05]   ## significant genes
## condiments
# res = readRDS(paste0('/home/whou10/scratch16/whou10/trajectory_variability/hca/real/testvar/result/condiments/', celltype, '/gender/cond_gene_res.rds'))
# res[is.na(res[,3]),3] <- 1
...
## monocle2 trajTest
res = readRDS(paste0('/home/whou10/scratch16/whou10/trajectory_variability/tb/res/sex_noBatch/pc2/monocle2_trajtest.rds'))
res = res[order(res[, 1]),]
...
res = readRDS(paste0('/home/whou10/scratch16/whou10/trajectory_variability/tb/res/sex_noBatch/pc2/monocle2_trajtest_corr.rds'))
res = res[order(res[, 1]),]
monocle2trajtestcorr_genes = rownames(res)
monocle2trajtestcorr_sig = rownames(res)[res[,'fdr'] < 0.05]
## phenopath 100 epoch
# fit <- readRDS(paste0('/home/whou10/scratch16/whou10/trajectory_variability/hca/real/testvar/result/phenopath100/', celltype, '/gender/fit_res.rds'))
...
genesSig = list(Lamian = lamiansig, 
                Lamian.chisq = lamcsig,
                monocle2Trajtest = monocle2trajtest_sig,
                monocle2TrajtestCorr = monocle2trajtestcorr_sig,
                limma = limmasig)
saveRDS(genesSig, paste0('/home/whou10/scratch16/whou10/trajectory_variability/tb/perf/violin_plotdata_genesSig.rds'))
...
genes = c(genes, sig)
saveRDS(genes, paste0('/home/whou10/scratch16/whou10/trajectory_variability/tb/perf/violin_plotdata_genes.rds'))
...
saveRDS(list(permud = permud, reald = reald), paste0('/home/whou10/scratch16/whou10/trajectory_variability/tb/perf/pvalue_violin_plotdata.rds'))
...
pdf('/home/whou10/scratch16/whou10/trajectory_variability/tb/perf/pvalue_violin_all.pdf',width=5.8, height=2.6)
ggplot() +
