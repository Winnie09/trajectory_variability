...
Res <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/res/time/pc2/lamian_pm.rds')
...
pdir <- rdir <- '/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/plot/time/pc2/'
