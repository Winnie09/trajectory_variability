...
res <- testpt('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/data/expr.h5', cellanno, pt, design=design,test.type='Variable')
saveRDS(res,file='/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/res/case/lamian_pm.rds')
