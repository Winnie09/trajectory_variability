...
des <- cbind(1,design[samp2,ncol(design)])
...
saveRDS(res,file=paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/batchrepro/res/batchnocor/',seed,'.rds'))
