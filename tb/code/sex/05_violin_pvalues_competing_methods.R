...
## Lamian.pm
lamian = readRDS('tb/res/sex_addBatch/pc2/lamian_pm_allcores.rds')[[1]]
...
## limma
limma <- readRDS(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/res/sex/pc2/limma.rds'))
...
lamc <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/res/sex_addBatch/pc2/lamian_chisq.rds')[[1]]
...
## monocle2 trajTest
res = readRDS(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/res/sex/pc2/monocle2_trajtest.rds'))
res = res[order(res[, 1]),]
...
res = readRDS(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/res/sex/pc2/monocle2_trajtest_corr.rds'))
res = res[order(res[, 1]),]
...
pdf(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/tb/perf/pvalue_violin_all.pdf'),width=13,height=4)
print(ggplot() + 
