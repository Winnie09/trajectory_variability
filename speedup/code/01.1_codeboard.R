...
expr = expr; cellanno = cellanno; pseudotime = pseudotime; design=design; permuiter=100; EMmaxiter=100; EMitercutoff=1; verbose=F; ncores=1; type='Time'; fit.resolution = 1000; test.pattern = 'overall'; demean=FALSE
test.pattern = 'overall'; test.position = 'all'; return.all.data = TRUE; 
