fitfunc <- function(iter, diffType = 'overall', gene = NULL,testvar=testvar, test.type = 'Time', EMmaxiter=100, EMitercutoff=0.05, verbose=F, ncores=1, expr=expr, cellanno=cellanno, pseudotime=pseudotime, design=design) {
