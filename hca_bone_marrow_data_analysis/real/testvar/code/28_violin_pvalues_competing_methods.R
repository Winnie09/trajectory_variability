...
for (celltype in setdiff(list.files('trajectory_variability/hca/real/testvar/result/EM_pm'),'perf')) {
  ...
  genes = c(genes, sig)
  saveRDS(genes, paste0('/home/whou10/scratch16/whou10/trajectory_variability/hca/real/testvar/plot/perf/',celltype,'_violin_plotdata_genes.rds'))
  ...
  saveRDS(list(permud = permud, reald = reald), paste0('/home/whou10/scratch16/whou10/trajectory_variability/hca/real/testvar/plot/perf/',celltype,'_pvalue_violin_plotdata.rds'))
  
  
  pdf(paste0('/home/whou10/scratch16/whou10/trajectory_variability/hca/real/testvar/plot/perf/',celltype,'_pvalue_violin_all.pdf'),width=13,height=4)
  print(ggplot() + 
  ...
  pdf(paste0('/home/whou10/scratch16/whou10/trajectory_variability/hca/real/testvar/plot/perf/',celltype,'_pvalue_violin_all_exc6.pdf'),width=6.5,height=4)
  print(ggplot() + 
