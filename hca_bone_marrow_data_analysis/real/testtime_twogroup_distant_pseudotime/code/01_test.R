...
rdir <- paste0('hca/real/testtime_twogroup/result/', method, '/monocyte/1256/')
...
# prepare data
# ------------
expr = readRDS(paste0(ddir, 'expr1.rds'))
cellanno = readRDS(paste0(ddir, 'cellanno1.rds'))
rownames(cellanno) <- cellanno[,1]
pseudotime = readRDS(paste0(ddir, 'pt1.rds'))
design = readRDS(paste0(ddir, 'design1.rds'))
