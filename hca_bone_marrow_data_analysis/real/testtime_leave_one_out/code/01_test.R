...
savefn <- paste0(rdir, 'testtime_res_1sample.rds') ###
source('./function/01_function.R')
# ------------
# prepare data
# ------------
expr = readRDS(paste0(ddir, 'expr_1sample.rds')) #####
cellanno = readRDS(paste0(ddir, 'cellanno_1sample.rds')) 
rownames(cellanno) <- cellanno[,1]
pseudotime = readRDS(paste0(ddir, 'pt_1sample.rds'))
design = readRDS(paste0(ddir, 'design_1sample.rds'))
