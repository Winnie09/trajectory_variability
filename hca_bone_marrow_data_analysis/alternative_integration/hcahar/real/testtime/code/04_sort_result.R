...
for (path in c('monocyte','erythroid','lymph')){
  print(path)
  rdir <- ddir <- paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcahar/real/testtime/result/', path)
  pdir  <- paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcahar/real/testtime/plot/', path)
  dir.create(pdir, recursive = T)
  source('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/function/01_function.R')
  # source('/home-4/whou10@jhu.edu/scratch/Wenpin/resource/myfunc/01_function.R')
  Res <- readRDS(paste0(ddir, '/EM_pm.rds'))
  ...
  res <- res[order(res$pval.overall, -res$z.overall), ]
