...
saveRDS(ov, 'hcaScvi/testvar/compare/overlap_with_seurat_res.rds')
saveRDS(ov.pm, 'hcaScvi/testvar/compare/overlap_with_seurat_res_pm.rds')
saveRDS(fdrmat, 'hcaScvi/testvar/compare/fdrmat_seurat_and_scvi.rds')
write.csv(fdrmat, 'hcaScvi/testvar/plot/overlap_with_seurat_res.csv')
...
theme_set(.new_theme)
pdf('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcaScvi/testvar/plot/overlap_with_seurat.pdf', height = 1.4, width = 2.1)
