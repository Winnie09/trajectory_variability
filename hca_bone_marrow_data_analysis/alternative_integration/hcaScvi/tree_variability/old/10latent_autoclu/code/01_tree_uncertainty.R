...
plotdir <- '/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcaScvi/tree_variability/10latent_autoclu/plot/'
rdir <- '/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcaScvi/tree_variability/10latent_autoclu/res/'
...
# permutation 
# res = infer_tree_structure(pca = pca, ct = ct, origin.celltype = 'HSC', plotdir = plotdir, xlab='scVI latent 1', ylab = 'scVI latent 2', number.cluster=NA, pcadim=NULL, original = F)
