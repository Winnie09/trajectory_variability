...
plotdir <- '/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcaScvi/tree_variability/2latent_autoclu/plot/'
rdir <- '/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcaScvi/tree_variability/2latent_autoclu/res/'
