...
for (j in seq(1,4)) { # signal from 1 weakest to 4 strongest
  ...
  add1 <- rbind(savercnt2[selgene1, ] + pmsavercnt2[fromgene[1:length(selgene1)], ], ## meanOnly
                savercnt2[selgene2, ], ## trendOnly
                savercnt2[selgene3, ] + m_with_halfmean) ## trendAndMean
