...
saveRDS(fit,file=paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hca/simu/testvar/addMultiSignalUsingExpr/result/phenopath100/fit_',f))
sig <- significant_interactions(fit)
saveRDS(sig,file=paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hca/simu/testvar/addMultiSignalUsingExpr/result/phenopath100/sig_',f))
