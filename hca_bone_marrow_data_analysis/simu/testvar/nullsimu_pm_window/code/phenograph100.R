...
saveRDS(fit,file='/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hca/simu/testvar/nullsimu_pm_window/result/phenopath100/fit.rds')
sig <- significant_interactions(fit)
saveRDS(sig,file='/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hca/simu/testvar/nullsimu_pm_window/result/phenopath100/sig.rds')
