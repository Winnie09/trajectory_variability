...
res <- read.csv(paste0('./auto_pc_auto_nclu_module_3traj/result/sample.cellcomp.sd.csv'), row.names = 1)
...
pdf('/Users/wenpinhou/Dropbox/trajectory_variability/tree_variability/perf/cellproportion_mean_sd.pdf', width = 7, height= 4.5)
