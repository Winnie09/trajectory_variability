d <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcacutoffs/cutmed/seuratrpca/pca.rds')
clu <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcacutoffs/cutmed/seuratrpca/cluster.rds')
ct <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcacutoffs/cutmed/seuratrpca/ct.rds')
library(ggplot2)
library(gridExtra)
library(scattermore)
source('/home-4/whou10@jhu.edu/scratch/Wenpin/resource/ggplot_theme.R')
theme_set(.new_theme)
pdf('/home-4/whou10@jhu.edu/scratch/Wenpin/trajectory_variability/hcacutoffs/cutmed/seuratrpca/ct.pdf',width=7.5,height=1.5)
